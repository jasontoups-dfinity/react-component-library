...
const DeveloperHeader = forwardRef<HTMLElement, DeveloperHeaderProps>(
  ({ appName, logo, showLayoutControls, showThemeToggle, className }, ref) => {
    ...
    if (!isEnabled) {
      return (
        <header
          ref={ref}
          className={cn('w-full flex flex-row justify-between items-center p-5', className)}>
          <Link
            to="/"
...
DeveloperHeader.displayName = 'DeveloperHeader';
